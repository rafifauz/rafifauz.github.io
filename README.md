...
<p align="center">
  ...
  <a href="https://github.com/rafifauz/Linktree/commits/master">
...
- [Demo](https://github.com/rafifauz/Linktree)

## 🚀 Getting started

If you installed git you can clone the code to your machine, or download a ZIP of all the files directly.
[Download the ZIP from this location](https://github.com/rafifauz/Linktree/archive/master.zip), or run the following [git](https://git-scm.com/downloads) command to clone the files to your machine:
```bash
git clone https://github.com/rafifauz/Linktree
```
...
Sourcee from: John Emerson :wave: [Get in touch](https://johnggli.github.io/linktree)
